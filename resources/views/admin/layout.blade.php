            ...
            <div class="container-fluid">
                <div class="header-mobile-inner">
                    <a class="logo" href="#">
                        ...
                        <img src="{{asset(Config::get('constants.logo'))}}" alt="CoolAdmin" />
        ...
        <nav class="navbar-mobile">
            <div class="container-fluid">
                <ul class="navbar-mobile__list list-unstyled">
                    ...
                    <li>
                        <a href="{{url('admin/category')}}"><i class="fas fa-th-list"></i>Category</a>
                    </li>
                    <li>
            ...
            <nav class="navbar-sidebar">
                <ul class="list-unstyled navbar__list">
                    ...
                    <li class="@yield('coupon_select')">
                        <a href="{{url('admin/coupon')}}"><i class="fa fa-tag"></i>Coupon</a>
                    </li>
                    <li class="@yield('size_select')">
                        <a href="{{url('admin/size')}}"><i class="fa fa-arrows-alt"></i>Size</a>
                    </li>
